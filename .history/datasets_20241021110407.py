...
def build_dataset(args):
    ...
    if args.dataset_name == 'Scene-15':
        ...
        data_list, labels = load_Caltech3v_data('data/Caltech-5V.mat', args)
        data_list = [StandardScaler().fit_transform(dv) for dv in data_list]
    elif args.dataset_name == 'Caltech_4V':
        data_list, labels = load_Caltech4v_data('data/Caltech-5V.mat', args)
        data_list = [StandardScaler().fit_transform(dv) for dv in data_list]
    elif args.dataset_name == 'Caltech_5V':
        data_list, labels = load_Caltech5v_data('data/Caltech-5V.mat', args)
        data_list = [StandardScaler().fit_transform(dv) for dv in data_list]
    else:
        pass
