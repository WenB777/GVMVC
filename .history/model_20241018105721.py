...
#         self.encoder_mu = torch.nn.Linear(self.z_dim, self.z_dim)
#         self.encoder_logvar = torch.nn.Linear(self.z_dim, self.z_dim)
#         self.softplus = nn.Softplus()

#     def forward(self, x, adj):
#         hidden_feature = self.encoder(x)
#         h = self.GConv(hidden_feature, adj)
#         mu = self.encoder_mu(h)
#         logvar = self.softplus(self.encoder_logvar(h))
#         # vs_var = nn.Softplus()(self.z_var_GConv(hidden_feature, adj))
