...
parser.add_argument('--dataset', type=int, default=0, choices=range(10), 
                    help='0:Scene-15, 1:RGBD, 2:Reuters_dim10, 3:Caltech101-20, 4:Caltech_2V, 5:Caltech_3V, 6:Caltech_4V, 7:Caltech_5V')    parser.add_argument('--interval', type=int, default=10)
